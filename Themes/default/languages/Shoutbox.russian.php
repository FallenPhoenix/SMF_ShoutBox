...
$txt['sbm_2'] = 'У вас нет прав на модерацию чата';
$txt['sbm_3'] = 'Доступ запрещён';
$txt['sbm_5'] = 'Навигация';
$txt['sbm_6'] = 'У вас нет прав на очистку чата'; // javascript alert
$txt['sbm_7'] = 'Мини-чат очищен'; // javascript alert
$txt['sbm_8'] = 'Подтвердите очистку чата'; // javascript alert
$txt['sbm_9'] = 'У вас нет прав на удаление сообщений'; // javascript alert
...
$txt['sbm_17'] = 'Заполните форму бана';
...
$txt['sbm_25'] = 'Подтвердите снятие бана'; // javascript alert
$txt['sbm_26'] = 'Бан снят'; // javascript alert
$txt['sbm_27'] = 'Бан изменён'; // javascript alert
...
$txt['sbas_backgroundColor'] = 'Фон поля ввода';
...
$txt['sbas_startShouts'] = 'Число сообщений, отображаемых при первой загрузке';
$txt['sbas_keepShouts'] = 'Число сохраняемых сообщений в <i>чате</i><br />' . $txt['sba_alert'];
$txt['sbas_height'] = 'Высота окна <i>мини-чата</i>';
$txt['sbas_printClass'] = 'Класс стиля сообщений (CSS)';
$txt['sbas_timeColor'] = 'Цвет даты и времени';
...
$txt['sbas_disableTags'] = 'Отключённые BB-теги:<br /><i>smileys, b, i, u, faces, color, bgcolor</i>';
